...
const Footer = () => {
  return (
    <footer className='mt-[60px] font-poppins text-sm font-normal text-dark1 sm:mt-[120px]'>
      <div className='grid grid-cols-2 gap-x-[63px] gap-y-[30px] px-4 sm:grid-cols-5 sm:gap-10 sm:px-52'>
        {/* Logo */}
        ...
        <div className='col-span-2 sm:col-span-1'>
          ...
          <div className='mb-[62px] mt-10 flex space-x-4 sm:hidden'>
      ...
      <div className='mx-auto mb-9 mt-[86px] hidden w-full border-t sm:block' />

      <div className='mb-10 flex flex-col items-center justify-between space-y-4 px-4 text-center text-xs text-gray-400 sm:flex-row sm:px-[180px] md:space-y-0'>
